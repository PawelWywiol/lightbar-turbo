	...
	return (
		<div className="flex gap-1 justify-center">
			<Button
				...
				onClick={() => shiftLightsFrame("prev")}
			>
				<ArrowLeftToLineIcon />
			</Button>
			<Button
				className={buttonClassName}
				onClick={() => shiftLightsFrame("left")}
			>
				<ArrowLeftFromLineIcon />
			</Button>
			<Button
				className={buttonClassName}
				onClick={() => shiftLightsFrame("up")}
			>
				<ArrowUpFromLineIcon />
			</Button>
			<Button
				className={buttonClassName}
				onClick={() => shiftLightsFrame("shuffle")}
			>
				<ShuffleIcon />
			</Button>
			<Button
				className={buttonClassName}
				onClick={() => shiftLightsFrame("down")}
			>
				<ArrowDownFromLineIcon />
			</Button>
			<Button
				className={buttonClassName}
				onClick={() => shiftLightsFrame("right")}
			>
				<ArrowRightFromLineIcon />
			</Button>
			<Button
				className={buttonClassName}
				onClick={() => shiftLightsFrame("next")}
			>
				<ArrowRightToLineIcon />
			</Button>
		</div>
